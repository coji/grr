/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a3a05ea5bf80f6efffcd2ee0b9b3e41)
// Runtime types generated with workerd@1.20260305.0 2025-10-08 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI_DIARY_REPLY_WORKFLOW: Workflow<Parameters<import("./workers/app").AiDiaryReplyWorkflow['run']>[0]['payload']>;
		MEMORY_EXTRACTION_WORKFLOW: Workflow<Parameters<import("./workers/app").MemoryExtractionWorkflow['run']>[0]['payload']>;
		MEMORY_CONSOLIDATION_WORKFLOW: Workflow<Parameters<import("./workers/app").MemoryConsolidationWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_LOGGING_LEVEL">> {}
}
