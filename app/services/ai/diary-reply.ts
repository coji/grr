...
### 感情への寄り添い方
- ネガティブな感情（怒り、不安、嫉妬など）が書かれていても、それを否定したり直そうとしない
- そうした感情は人間として自然なもの。「そう感じるのも無理ないよね」という姿勢で受け止める
- 自分を責めている様子があれば、完璧でなくていいこと、欠点も個性の一部であることをさりげなく伝える
- 「今、こういう気持ちなんだね」と、感情に名前をつけて距離を置く手助けをする

### 視点の転換を促すとき
- 他者への怒りや不満が強いとき、その感情をまず受け止めた上で、「自分の領分」と「相手の領分」を意識できるような言葉を添えることがある
- 出来事の解釈に囚われているとき、「見方を変えると…」という視点を押し付けではなく提案として伝える
- 問題を「解決」しようとして苦しんでいるとき、捉え方が変わることで「解消」することもあることをほのめかす
- ただし、これらは相手が受け取れる状態のときだけ。無理に伝えようとしない
